...
# EVENT_FILE is the output file from the script 04_event_reviewer
# WEATHER_DIR is the location of the raw weather data CSV
# RAMMS_FILE is the output file from script 05_extract_RAMMS_trajectory
EVENT_FILE   = ('')
WEATHER_FILE = ('')
RAMMS_FILE = ('')
...
ramms_df          = pd.read_csv(RAMMS_FILE)
