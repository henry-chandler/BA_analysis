...
# RAW_INF_DATA_DIR should be the directory in which the raw infrasound data was saved from script 01_data_download
# OUTPUT_DIR is where the results of the event identification will be saved
RAW_INF_DATA_DIR = ''
OUTPUT_DIR = ''
FIGURES_DIR = ''
...
np.save(
    os.path.join(OUTPUT_DIR, f'{base_name}_event_id.npy'),
    {
        'event_idx': event_idx,
