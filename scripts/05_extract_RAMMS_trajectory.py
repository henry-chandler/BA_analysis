...
# RAMMS directory containing the RAMMS "output" file
RAMMS_DIR = ''

# RAMMS trajectory shapefile filename
SHAPEFILE = ''

# Output trajectory path and CSV filename
OUTPUT_CSV = ''
...
# Target projected CRS — UTM Zone 6N (EPSG:32606) covers the Barry Arm study area
...
# Drop rows with null or empty geometries before extracting coordinates
null_count = gdf.geometry.isna().sum()
if null_count > 0:
    print(f'  WARNING: {null_count} trajectories with null geometry dropped.')
